...
function mapPlayerRow(
  ...
  return {
    ...
    accuracyRaw: stats.accuracy ?? null,
    accuracyEnemySpottedRaw: stats.accuracy_enemy_spotted ?? null,
    sprayAccuracyRaw: stats.spray_accuracy ?? null,
    counterStrafeRatioRaw: stats.counter_strafing_shots_good_ratio ?? null,
    tradeKillSuccessRaw: stats.trade_kills_success_percentage ?? null,
    utilityOnDeathAvg: stats.utility_on_death_avg ?? null,
    heDamagePerNade: stats.he_foes_damage_avg ?? null,
    flashLeadingToKill: stats.flashbang_leading_to_kill ?? null,
    kills,
    deaths,
